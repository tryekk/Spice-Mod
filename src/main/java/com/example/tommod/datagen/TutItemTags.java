...
public class TutItemTags extends ItemTagsProvider {
    ...
    public TutItemTags(DataGenerator generator, BlockTagsProvider blockTags, ExistingFileHelper helper) {
        super(generator, blockTags, TomMod.MODID, helper);
    }
    ...
    protected void addTags() {
        tag(Tags.Items.ORES)
                ...
                .add(Registration.SPICE_ORE_NETHER_ITEM.get())
                .add(Registration.SPICE_ORE_END_ITEM.get())
                .add(Registration.SPICE_ORE_DEEPSLATE_ITEM.get());
    }
